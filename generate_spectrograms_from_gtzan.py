...
# Output directory
OUTPUT_BASE = "spectrogram_dataset_stft"
...
def save_spectrogram(y, sr, output_path):
    ...
    librosa.display.specshow(D_db, sr=sr, hop_length=HOP_LENGTH, x_axis=None, y_axis=None, cmap="magma")
    plt.axis("off")
...
if __name__ == "__main__":
    print("🚀 Generating STFT spectrograms with trim+normalize+windowing...")
